...
import { validateMatterScope } from '@/app/api/rag/_lib/matter-policy';
...
export async function POST(req: Request) {
  try {
    ...
    logRouteException('/api/rag/feedback', 'POST', error);
    return NextResponse.json({ error: 'Feedback istegi islenemedi.' }, { status: 503 });
  }
}
